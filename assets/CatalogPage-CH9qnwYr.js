...
`,x=t.h3`
    ...
    padding-bottom: 24px;
    margin-bottom: 24px;
    border-bottom: ${r.border.lightGrey};
`,D=t.p`
    font-size: 16px;
    font-weight: 500;
    line-height: 1.5;
...
`,oe=t.button`
    ...
    cursor: pointer;
`,ae=({camper:a})=>{const{gallery:s,name:l,location:h,price:c,description:u,adults:m,engine:w,details:d,transmission:y,rating:i,reviews:o}=a,[n,g]=v.useState(!1),f=[{name:`${m}`,label:`${m} adults`,icon:"people",reverseStyle:!0},{name:`${y.authomatic}`,label:"Automatic",icon:"automatic",reverseStyle:!1},{name:`${w}`,label:`${w}`,icon:"fuel",reverseStyle:!0},{name:`${d.airConditioner}`,label:"AC",icon:"clima",reverseStyle:!0},{name:`${d.kitchen}`,label:"Kitchen",icon:"kitchen",reverseStyle:!1},{name:`${d.beds}`,label:`${d.beds} beds`,icon:"bed",reverseStyle:!1}],S=()=>{g(!n)};return e.jsxs(W,{children:[e.jsx(G,{children:e.jsx(P,{src:s[0],alt:l})}),e.jsxs(J,{children:[e.jsxs(Q,{children:[e.jsx(j,{children:l}),e.jsxs(N,{children:[e.jsxs(j,{children:["€",c.toFixed(2)]}),e.jsx(oe,{onClick:S,children:e.jsx("svg",{width:"24",height:"24",children:n?e.jsx("use",{fill:"transparent",stroke:`${r.color.dark}`,href:`${p}#fav`}):e.jsx("use",{fill:"transparent",stroke:`${r.color.dark}`,href:`${p}#nofav`})})})]})]}),e.jsxs(X,{children:[e.jsxs(re,{href:"",children:[e.jsx("svg",{width:"16",height:"16",children:e.jsx("use",{href:`${p}#star`})}),i,"(",o.length," Reviews)"]}),e.jsxs(ie,{children:[e.jsx("svg",{width:"16",height:"16",fill:"transparent",stroke:`${r.color.dark}`,children:e.jsx("use",{href:`${p}#map-pin`})}),h]})]}),e.jsx(Y,{children:u}),e.jsx(ee,{children:f.map(A=>{const{name:b,label:B,icon:$,reverseStyle:z}=A;return b&&e.jsxs(Z,{children:[e.jsx(te,{reverseStyle:z,children:e.jsx("use",{href:`${p}#${$}`,alt:b})}),e.jsx("span",{children:B})]},b)})}),e.jsx(_,{children:"Show more"})]})]})},ne=()=>{const[a,s]=v.useState([]),[l,h]=v.useState(null),c=[{name:"airConditioner",label:"AC",icon:"clima",reverseStyle:!0},{name:"transmission",label:"Automatic",icon:"automatic",reverseStyle:!1},{name:"kitchen",label:"Kitchen",icon:"kitchen",reverseStyle:!1},{name:"TV",label:"TV",icon:"tv",reverseStyle:!1},{name:"bathroom",label:"Shower/WC",icon:"shower",reverseStyle:!1}],u=[{name:"van",label:"Van",icon:"van",reverseStyle:!0},{name:"integrated",label:"Fully Integrated",icon:"fully",reverseStyle:!0},{name:"alcove",label:"Alcove",icon:"alcove",reverseStyle:!0}],m=i=>{s(o=>o.includes(i)?o.filter(n=>n!==i):[...o,i])},w=i=>{h(o=>o===i?null:i)},d=i=>a.includes(i),y=i=>l===i;return e.jsxs(E,{children:[e.jsxs(V,{type:"submit",children:[e.jsxs(R,{children:[e.jsx(F,{for:"location",children:"Location"}),e.jsx(I,{type:"name",id:"location",placeholder:"Please enter location"})]}),e.jsxs(k,{children:[e.jsx(D,{children:"Filters"}),e.jsx(x,{children:"Vehicle equipment"}),e.jsx(C,{children:c.map(i=>{const{name:o,label:n,icon:g,reverseStyle:f}=i;return e.jsx(T,{label:n,name:o,icon:g,onChange:m,checked:d(o),reverseStyle:f},o)})})]}),e.jsxs(k,{children:[e.jsx(x,{children:"Vehicle type"}),e.jsx(C,{children:u.map(i=>{const{name:o,label:n,icon:g,reverseStyle:f}=i;return e.jsx(T,{label:n,name:o,icon:g,onChange:w,checked:y(o),reverseStyle:f},o)})})]}),e.jsx(q,{children:"Search"})]}),e.jsx(M,{children:e.jsx("ul",{children:K.map(i=>e.jsx(ae,{camper:i},i._id))})})]})};function le(){return e.jsx(ne,{})}export{le as default};
